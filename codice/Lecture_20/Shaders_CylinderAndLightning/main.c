...
void setup(void)
{
    ...
    // Load the images.
    image[0] = readBMP("./canLabel.bmp");
    image[1] = readBMP("./canTop.bmp");
...
int main(int argc, char **argv)
{
    ...
    printf("Interaction: \n");
    printf("Press x, X, y, Y, z, Z to turn the cylinder. \n");
    ...
    glutCreateWindow("Cylinder with material and lightning");
