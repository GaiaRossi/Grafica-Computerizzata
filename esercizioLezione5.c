...
void display(void)
{
    ...
    //il primo parametro e l'angolo di rotazione
    //gli altri tre parametri specificano le coordinate
    //del vettore attorno a cui ruotare
    //generalmente capisco meglio se ci sta il versore
    //di un'asse
